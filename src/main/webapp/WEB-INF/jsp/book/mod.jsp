	...
	<table class="table table-bordered" style="border: 1px solid red; width:70%; height: 100px; margin: auto; text-align: center;">
		<tbody>
			<tr>
				...
				<td> <input type="text" class="form-control" id="name" name="name" value="${data.name }"> </td>
			</tr>
			<tr> 
				<td><label class="col-sm-2 control-label" >title</label></td> 
				<td><input type="text" class="form-control" id="title" name="title" value="${data.title }"></td>
			</tr>
			<tr> 
				<td><label class="col-sm-2 control-label" >price</label></td> 
				<td><input type="text" class="form-control" id="price" name="price" value="${data.price }"></td>
			</tr>
			<tr> 
				<td><label class="col-sm-2 control-label" >description</label></td> 
				<td><input type="text" class="form-control" id="description" name="description" value="${data.description }"></td>
			</tr>
			<tr>
				<td colspan=2>
