	...
	<table class="table table-bordered" style="border: 1px solid red; width:70%; height: 100px; margin: auto; text-align: center;">
		<tbody>
			<tr>
				...
				<td> <input type="text" class="form-control" id="email" name="email" placeholder="email-input"> </td>
			</tr>
			<tr> 
				<td><label class="col-sm-2 control-label" >password</label></td> 
				<td><input type="text" class="form-control" id="password" name="password" placeholder="password input"></td>
			</tr>
			<tr>
				<td colspan=2>
